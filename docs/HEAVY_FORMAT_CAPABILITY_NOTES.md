...
| PDF | enhanced | 文本型 PDF 抽取；程序化 PDF 输出支持分页和 link annotation 基线 | text order approximated, scan requires local OCR plugin | 50 MB input / 1024 MB runtime | 扫描件、复杂版面和表格恢复交给本地插件 |
